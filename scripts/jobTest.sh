...
#PBS -e localhost:/projects/hackonomics/energy/log/${sample}_${effect}_${log}_${iter}.err
#PBS -o localhost:/projects/hackonomics/energy/log/${sample}_${effect}_${log}_${iter}.log
...
SOURCE_SCRIPT=/projects/hackonomics/energy/test.R
###SOURCE_SCRIPT=/projects/hackonomics/energy/power_calcs_simulation_V200.R
OUTPUT_PATH=/projects/hackonomics/energy/${output}/result_${sample}_${effect}_${log}_${iter}.csv
LOG_PATH=/projects/hackonomics/energy/log/${sample}_${effect}_${log}_${iter}
